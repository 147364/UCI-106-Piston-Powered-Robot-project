  ...
  #define pinReed               5
    ...
    LIS3MDL::vector<int16_t> m_min = { -2901,  -1657,  +1214};
    LIS3MDL::vector<int16_t> m_max = { -1241,   +202,  +1491};
...
long intervalPistonOff = 800;
long intervalPistonOn = 800;
 ...
 /* #define forwardFires         3
  ...
  #define turnFires            3 */
    ...
    float targetHeading = 337.0;       // Desired direction (adjustable)
